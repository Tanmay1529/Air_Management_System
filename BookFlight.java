...
public class BookFlight extends JFrame implements ActionListener{
    ...
    JTextField  tfaadhar;
    JLabel tfname, tfnationality, tfaddress, tfemail, labelgender, labelfname, labelfcode;
    ...
    public BookFlight(){
        ...
        ImageIcon il = new ImageIcon(Thread.currentThread().getContextClassLoader().getResource("airlinemanagementsystem/icons/details.jpg"));
